...
impl<'a, 'gc> Activation<'a, 'gc> {
    ...
    pub fn local_register(&mut self, id: u32) -> Value<'gc> {
        ...
        // Verification guarantees that this retrieves a local and not a stack entry
    ...
    pub fn set_local_register(&mut self, id: u32, value: impl Into<Value<'gc>>) {
        ...
        // Verification guarantees that this modifies a local and not a stack entry
        self.avm2()
    ...
    /// is done executing; otherwise, unused values may accumulate on the stack.
    #[inline]
    ...
    fn clear_stack(&mut self) {
        ...
        let stack_depth = self.stack_depth;
        self.avm2().truncate_stack(num_locals + stack_depth);
    }
